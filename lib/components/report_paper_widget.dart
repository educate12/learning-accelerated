...
class ReportPaperWidget extends StatefulWidget {
  const ReportPaperWidget({
    Key? key,
    this.paper,
  }) : super(key: key);
  ...
  @override
  _ReportPaperWidgetState createState() => _ReportPaperWidgetState();
}

class _ReportPaperWidgetState extends State<ReportPaperWidget> {
                    ...
                    children: [
                      if (textController!.text != null &&
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'REPORT_PAPER_COMP_SUBMIT_BTN_ON_TAP');
                            ...
                            final reportingCreateData =
                              ...
                              reportedPaper: containerPapersRecord.reference,
                            );
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      'We appreciate your reporting, we will make sure to check the paper and act accordingly,\n\nThanks for working with us to keep our App clean and user friendly.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
