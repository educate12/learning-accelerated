...
class ReportUserWidget extends StatefulWidget {
  ...
  @override
  _ReportUserWidgetState createState() => _ReportUserWidgetState();
}
                    ...
                    children: [
                      if (textController!.text != null &&
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'REPORT_USER_COMP_SUBMIT_BTN_ON_TAP');
                            ...
                            final reportingCreateData =
                              ...
                              reportedUser: containerUsersRecord.reference,
                            );
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      'We appreciate your reporting, we will make sure to check the user and act accordingly,\n\nThanks for working with us to keep our App clean and user friendly.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
