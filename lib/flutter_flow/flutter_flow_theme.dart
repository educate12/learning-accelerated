...
abstract class FlutterFlowTheme {
  ...
  late Color byzantine;
  late Color purple;
  late Color purple2;
  late Color trypanBlue;
  late Color trypanBlue2;
  late Color persianBlue;
  late Color ultramarineBlue;
  late Color dodgerBlue;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color byzantine = Color(0xFFB5179E);
  late Color purple = Color(0xFF7209B7);
  late Color purple2 = Color(0xFF560BAD);
  late Color trypanBlue = Color(0xFF480CA8);
  late Color trypanBlue2 = Color(0xFF3A0CA3);
  late Color persianBlue = Color(0xFF3F37C9);
  late Color ultramarineBlue = Color(0xFF4361EE);
  late Color dodgerBlue = Color(0xFF4895EF);
  late Color vividSkyBlue = Color(0xFF4CC9F0);
